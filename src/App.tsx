...
function App() {
    return (
        <div className="bg-white w-screen h-screen p-10 flex flex-col ">
            ...
            <main className="flex-1 w-[90%] flex gap-10 mx-auto ">
                ...
                <div className="w-[55%] p-10 flex flex-col gap-4">
                    <div className=" flex flex-col items-center">
                        ...
                        <p className="text-center text-gray-400">
                            ...
                            elit. Labore, necessitatibus.
                        </p>
                    </div>

                    <form action="" className="flex flex-col gap-2 mt-10">
                        <div className="bg-[#fafafa] flex p-4 rounded-lg gap-2">
                            <svg
                        ...
                        <a className="text-gray-400 self-end my-1">
                            Forgot password?
                        </a>

                        <div className="w-[80%] flex gap-2 ">
                            <button className="bg-[#07085B] w-full p-2 rounded-3xl text-white">
                                Login now
                            </button>

                            <button
                                className="w-full p-2 rounded-3xl border border-slate-200
                             "
                            >
                                Create account
                            </button>
